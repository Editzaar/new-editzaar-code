...
(function () {
  ...
  var LIGHT_CSS = [
    ...
    'html[data-theme="light"] h1, html[data-theme="light"] h1 * { color: ' + LIGHT_BLUE + ' !important; }',
    'html[data-theme="light"] h2, html[data-theme="light"] h2 * { color: ' + LIGHT_BLUE + ' !important; }',
    'html[data-theme="light"] h3, html[data-theme="light"] h3 * { color: ' + LIGHT_BLUE + ' !important; }',
    'html[data-theme="light"] h4, html[data-theme="light"] h4 * { color: ' + LIGHT_BLUE + ' !important; }',
    'html[data-theme="light"] h5, html[data-theme="light"] h5 * { color: ' + LIGHT_BLUE + ' !important; }',
    'html[data-theme="light"] h6, html[data-theme="light"] h6 * { color: ' + LIGHT_BLUE + ' !important; }',
    'html[data-theme="light"] .hv2-headline { color: ' + LIGHT_BLUE + ' !important; }',
    'html[data-theme="light"] .hv2-headline * { color: ' + LIGHT_BLUE + ' !important; }',
    'html[data-theme="light"] .hv2-headline .typing-wrap { color: ' + LIGHT_BLUE + ' !important; }',
    'html[data-theme="light"] #typing-target { color: ' + LIGHT_BLUE + ' !important; }',
    'html[data-theme="light"] #typing-target * { color: ' + LIGHT_BLUE + ' !important; }',
    ...
    /* Cursor Blink */
    'html[data-theme="light"] .cursor-blink { border-right: 2px solid ' + LIGHT_BLUE + ' !important; color: transparent !important; }',
